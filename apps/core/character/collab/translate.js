...
const translates = {
	...
	wuhujiang_prefix: "魂",
	olhuyi: "虎翼",
	olhuyi_info: "①游戏开始时，你从随机三个五虎将技能中选择一个获得。②当你使用或打出一张基本牌后，若你因此技能获得的技能数小于5，你随机获得一个技能描述中包含此牌名的五虎将技能。③当你因此技能获得技能后，若与你拥有的其他技能同名，你可以弃置其中一个并摸一张牌。④回合结束时，你可以弃置任意个以此法获得的技能，然后摸等量张牌，并亮出牌堆顶X+2张牌（X为你以此法弃置的技能数），将这些牌以任意顺序置于牌堆顶。",
	liuxiecaojie: "刘协曹节",
	dcjuanlv: "眷侣",
